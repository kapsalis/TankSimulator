...
## It simulates the operation of a Sensor that controls the highest level of the tank
...
class modbusServer:
    ...
    ##which is the highest level sensor's data
    def sensorData(self):
        sH = 0  ##The sensor state variable
        while True:
            ##Opens the file
